...
def delayed_variable_interpretation(df, variables=None):
    """
    ...
    :param variables: Current variables dictionary to add to
    """
    if variables is None:
        variables = {}
...
def replace_templated_values(
    ...
    if isinstance(recipe_object, list):
        ...
        new_recipe_object = [
            replace_templated_values(element, variables, ignore_unknown_variables)
