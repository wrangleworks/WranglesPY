...
def test_non_existing_unit():
    ...
    assert info.typename == 'ValueError' and info.value.args[0] == 'ERROR IN WRANGLE #1 extract.attributes - at line 3 - Status Code: 400 - Bad Request. {"ValueError":"Invalid desiredUnit provided"}\n \n'
