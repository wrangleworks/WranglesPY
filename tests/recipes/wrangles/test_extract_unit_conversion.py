...
def test_non_existing_unit():
    ...
    """
    data = pd.DataFrame({"col": ["1000 W", "1000 watts", ".01 MW", "1 kW", "1 hp"]})
    ...
    assert (
        ...
        == 'extract.attributes - Status Code: 400 - Bad Request. {"ValueError":"Invalid desiredUnit provided"}\n \n'
    )
...
def test_current_conversion_1():
    ...
    """
    data = pd.DataFrame({"col": ["something 1300 amps something"]})
    df = wrangles.recipe.run(
        recipe="""
        wrangles:
          - extract.attributes:
...
def test_multile_forces():
    ...
    data = pd.DataFrame(
        {
            "col": [
                "something 1300 newtons something",
                "something 1300 pounds something",
                "something 1300 lbf",
            ]
        }
    )
...
def test_volumetric_flow_rate_conversion_2_obj():
    ...
    assert df["out"][1] == [
        {
            "span": "10 gallon per minute",
            "standard": "10 gpm",
            "symbol": "gpm",
            "unit": "gallon per minute",
            "value": 10.0,
        }
    ]
...
def test_degree_conversion_1():
    ...
    """
    data = pd.DataFrame({"col": ["1000 radian", "1000 radian"]})
    df = wrangles.recipe.run(
        recipe="""
        wrangles:
          - extract.attributes:
...
def test_frequency_conversion_1():
    ...
    """
    data = pd.DataFrame({"col": ["1000 hertz", "1000 Hz", "100 kHz", "0.1 MHz"]})
    df = wrangles.recipe.run(
        recipe="""
        wrangles:
          - extract.attributes:
...
def test_charge_conversion_1():
    ...
    """
    data = pd.DataFrame({"col": ["10 coulomb", "10000 mC"]})
    df = wrangles.recipe.run(
        recipe="""
        wrangles:
          - extract.attributes:
...
def test_data_transfer_rate_conversion_1():
    ...
    """
    data = pd.DataFrame({"col": ["10000000 bps", "1000 kbps", "1 gbps"]})
    df = wrangles.recipe.run(
        recipe="""
        wrangles:
          - extract.attributes:
...
def test_electrical_conductance_conversion_1():
    ...
    """
    data = pd.DataFrame({"col": ["100 siemens"]})
    df = wrangles.recipe.run(
        recipe="""
        wrangles:
          - extract.attributes:
...
def test_inductance_conversion_1():
    ...
    """
    data = pd.DataFrame({"col": ["1000 henry", "1000 H"]})
    df = wrangles.recipe.run(
        recipe="""
        wrangles:
          - extract.attributes:
...
def test_frequency_conversion_2():
    ...
    """
    data = pd.DataFrame({"col": ["1000 rpm", "1000 cps"]})
    df = wrangles.recipe.run(
        recipe="""
        wrangles:
          - extract.attributes:
...
def test_lumens_conversion_1():
    ...
    """
    data = pd.DataFrame({"col": ["1000 lumens", "1000 lm"]})
    df = wrangles.recipe.run(
        recipe="""
        wrangles:
          - extract.attributes:
...
def test_energy_conversion_1():
    ...
    """
    data = pd.DataFrame({"col": ["1000 joules", "1000 J", "10 kilojoules", "1 kwh"]})
    df = wrangles.recipe.run(
        recipe="""
        wrangles:
          - extract.attributes:
