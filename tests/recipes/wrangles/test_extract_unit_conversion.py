...
def test_non_existing_unit():
    ...
    assert type(info.value).__name__ == 'ValueError' and info.value.args[0] == 'ERROR IN WRANGLE #1 extract.attributes - Status Code: 400 - Bad Request. {"ValueError":"Invalid desiredUnit provided"}\n \n'
