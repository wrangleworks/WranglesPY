...
class TestStandardizeAttributes:
    ...
    # Testing remove attributes with standardize function
    ...
    def test_remove_all_attributes(self):
        ...
        assert df['output'][0] == ['My car has a mass of and it holds of gasoline with a battery of and of thread left']